    ...
    <>
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div
          ...
          <h1 className="font-extrabold text-[4rem] md:text-[5rem] leading-10">Phuree Kanusont</h1>
          <h3 className="font-bold text-sm md:text-2xl mt-5">Software Engineer • Web Developer • Artists</h3>
        </div>
